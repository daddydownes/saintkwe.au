(() => {
 ...
 document.addEventListener('keydown',e=>{if(e.key==='Escape'){if(window.KweTransitions)window.KweTransitions.navigate('index.html#listen');else{suspend();location.href='index.html#listen';}}});
